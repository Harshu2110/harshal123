...
client = pymongo.MongoClient("mongodb+srv://bhendareh1:21102000@cluster0.ngzoiau.mongodb.net/?retryWrites=true&w=majority")
db = client.test

data = {
    "name" : "Harshu",
    "mail_id" : "bhendareh@gmail.com",
    "subject" : ["mathematics", "science", "phycis"]
}
list_of_records = [
    {'companyName': 'iNeuron',
